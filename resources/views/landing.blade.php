...
<html lang="en">
    ...
    <section>
                ...
                <div class="container-fluid" style="background: linear-gradient(180deg, #222  5%, #000 100%);">
                    ...
                    <div class="row">
                        ...
                        <h1 class="text-white fw-bold fs-1">Fauzan Reza Arnanda</h1>
  ...
  <path fill="#4802fa" fill-opacity="1" d="M0,160L120,176C240,192,480,224,720,234.7C960,245,1200,235,1320,229.3L1440,224L1440,0L1320,0C1200,0,960,0,720,0C480,0,240,0,120,0L0,0Z" style="user-select: auto;"></path>
    ...
    <div class="col fw-bolder text-center fs-2 mb-4 hc">
            <p>Riwayat Pendidikan</p>
        </div>
    <main class="rounded-3 mb-4 p-3">
    ...
    <section>
        <img class="img-fluid" src="{{asset('assets/wvdown.png')}}" alt='' width="100%">
        <div class="container-fluid pb-5 inwave" style="background: #000; margin-top: -8px;">
        <div class="col fw-bolder text-center fs-2 mb-2 pb-3 text-white" style="font-family: 'Inter', sans-serif;">
            <p>SKILLS</p>
        </div>
        ...
        <img class="img-fluid wave-down" src="{{asset('assets/sklwave.png')}}" alt='' width="100%">
    </section>
    
    <section>
        <footer class="container-fluid pb-3 text-center" style="background:white; margin-top: -90px; padding-top:70px;">
